...
Example:
```
NEAR_ENV=shardnet near deploy shogun.shardnet.near --wasmFile target/wasm32-unknown-unknown/release/contract.wasm
```
...
Example:
```
CONTRACT_ID=shogun.shardnet.near
NEAR_ENV=shardnet near call $CONTRACT_ID new '{"staking_pool_account_id": "shogun.factory.shardnet.near", "owner_id":"shogun.shardnet.near", "reward_receivers": [["shashinka.shardnet.near", {"numerator": 3, "denominator":10}], ["shogun.shardnet.near", {"numerator": 70, "denominator":100}]]}' --accountId $CONTRACT_ID
```
